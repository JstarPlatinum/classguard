...
## Air Quality Code Protocol

ESP32 uploads compact evaluation codes and the server expands them into display text:
...
"air_quality": {
  ...
  "score": 70.0,
  "level_code": "good",
  "action": "early_ventilation",
  "redlines": ["co2_gt_1000", "occupancy_ge_80"],
  "main_reasons": ["occupancy", "co2"]
}
```

Text such as the Chinese level, warning labels, and user suggestion message is generated by `database.py`.
